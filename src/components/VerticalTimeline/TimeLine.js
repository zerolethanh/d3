...
// import jQuery from './vertical-timeline'
...
export default class TimeLine extends Component {
  ...
  render() {
    ...
    return (
        <div>
          <button onClick={this.handlePrevPage} disabled={!this.state.prev_page_url || this.state.querying}>PrevPage
          </button>
          <button onClick={this.handleNextPage} disabled={!this.state.next_page_url || this.state.querying}>NextPage
          </button>
          <div id="timeLine">
            {
              posts.length > 0 &&
